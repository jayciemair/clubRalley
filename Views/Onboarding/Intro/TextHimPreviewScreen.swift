...
struct TextHimPreviewScreen: View {
    ...
    private let phrases: [String] = [
        "ever consider sending just a small \"hey\" message?",
        "we can show you the probable outcome"
    ]
            ...
            OnboardingScrollableLayout(
                ...
                VStack(spacing: 0) {
                    ...
                    ZStack(alignment: .topLeading) {
                        ...
                        Text("ever consider sending just a small \"hey\" message?\n\nwe can show you the probable outcome")
                ...
                flowController.saveData(for: "text_him_preview", data: [
                    "viewed": true,
...
struct TextHimPreviewScreen_Previews: PreviewProvider {
