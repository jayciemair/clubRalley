...
struct LoveIsADrugScreen: View {
    ...
    private let phrases: [String] = [
        "love is literally like a drug.",
        "your brain got hooked on the dopamine, the oxytocin, all of it.",
        "and now you're in withdrawal.",
    ...
    var body: some View {
        ZStack {
            ...
            OnboardingScrollableLayout(
                ...
                flowController.saveData(for: "love_is_a_drug", data: [
                    "viewed": true,
...
struct LoveIsADrugScreen_Previews: PreviewProvider {
