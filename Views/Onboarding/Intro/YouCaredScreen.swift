...
struct YouCaredScreen: View {
    ...
    private var phrases: [String] {
        [
            "it's clear you actually cared about him.",
            "but now you get to pour that love into yourself too 🩷"
        ]
    }
            ...
            OnboardingScrollableLayout(
                ...
                VStack(spacing: 0) {
                    ...
                    ZStack(alignment: .topLeading) {
                        ...
                        Text("it's clear you actually cared about him.\n\nbut now you get to pour that love into yourself too 🩷")
                ...
                flowController.saveData(for: "you_cared", data: [
                    "viewed": true,
...
struct YouCaredScreen_Previews: PreviewProvider {
