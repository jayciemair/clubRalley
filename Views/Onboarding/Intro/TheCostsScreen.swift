            ...
            OnboardingScrollableLayout(
                ...
                VStack(spacing: 0) {
                    ...
                    ZStack(alignment: .topLeading) {
                        ...
                        Text("your friends, your family, everyone around you wants to see you move on.\n\nbut more importantly, you owe it to yourself")
                ...
                flowController.saveData(for: "the_costs", data: [
                    "viewed": true,
...
struct TheCostsScreen_Previews: PreviewProvider {
