...
struct MochiHelpScreen: View {
    ...
    private let phrases = [
        ...
        "whenever you need to vent, i'm here 24/7",
        "and if you ever get the urge to text him... you already know we've got that covered 😉"
    ]
    ...
    var body: some View {
        ZStack {
            ...
            OnboardingScrollableLayout(
                ...
                flowController.saveData(for: "mochi_help", data: [
                    "viewed": true,
...
struct MochiHelpScreen_Previews: PreviewProvider {
