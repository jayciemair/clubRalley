...
struct HealingNotLinearScreen: View {
    ...
    private let phrases: [String] = [
        ...
        "some days you'll need to vent at 2am, or talk through the same thing for the 10th time.",
        "this is your space to do that 🩷"
    ]
        ...
        ZStack {
            ...
            OnboardingScrollableLayout(
                ...
                VStack(spacing: 0) {
                    ...
                    // Mochi offset to the left - no animation
                    HStack {
                        Image("Mochi")
                            .resizable()
                            .scaledToFit()
                ...
                flowController.saveData(for: "healing_not_linear", data: [
                    "viewed": true,
...
struct HealingNotLinearScreen_Previews: PreviewProvider {
