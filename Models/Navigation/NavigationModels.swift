...
struct TabSelection {
    ...
    var ralleysNavigation: [NavigationRoute] = []
    ...
    mutating func navigate(to route: NavigationRoute, in tab: MainTab) {
        ...
        case .ralleys:
            ralleysNavigation.append(route)
        case .post:
    ...
    mutating func pop(in tab: MainTab) {
        ...
        case .ralleys:
            if !ralleysNavigation.isEmpty {
                ralleysNavigation.removeLast()
            }
        case .post:
            break // Post is modal
        case .teams:
